...
export const getStyles = (
    ...
    textarea: clsx(
        'scroll w-full h-24 p-2 bg-transparent border rounded-lg resize-none enabled:border-zinc-400 enabled:focus:border-primary enabled:active:border-primary outline-0',
        {
            'border-warning ': error,
            'text-white enabled:focus:border-white': isWhiteText,
            'enabled:border-zinc-400': !isWhiteText,
