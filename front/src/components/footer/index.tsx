...
export const Footer = () => {
  ...
  return (
    <footer className="w-full bg-mainGradient pt-[60px] pb-[80px] tablet:px-10 desktop:py-[60px] desktop:px-0">
      <div className="max-w-[240px] w-full mx-auto flex flex-col items-center gap-[40px] tablet:max-w-full desktop:max-w-[1620px] desktop:px-4">
        <Logo />
        ...
        <div className="flex flex-col gap-8 tablet:flex-row tablet:flex-wrap tablet:justify-between desktop:gap-0 desktop:w-full">
          <div className="flex flex-col gap-5 text-center text-white font-montserrat tablet:max-w-[200px] tablet:w-full tablet:text-start">
            ...
            <p className="font-normal text-[14px]">{t('footer.addresses')}</p>
          </div>

          <div className="flex flex-col gap-5 text-center text-white font-montserrat tablet:max-w-[200px] tablet:w-full tablet:text-start">
            <h6 className="font-semibold">{t('footer.tel_title')}</h6>

            <a href="tel:+380001232233" className="font-normal text-[14px]">
              +38(000)123 22 33
            </a>
          </div>

          <div className="flex flex-col gap-5 text-center text-white font-montserrat tablet:max-w-[200px] tablet:w-full tablet:text-start">
            <h6 className="font-semibold">{t('footer.write_us_title')}</h6>
        ...
        <p className="text-white">{t('footer.copyright')} &copy; 2023 URA </p>
      </div>
    </footer>
  );
};
