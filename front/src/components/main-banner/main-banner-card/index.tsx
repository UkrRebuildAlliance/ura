...
export const MainBannerCard = ({ href, ttl, content }: IMainBannerCard) => {
  return (
    <div className="relative flex flex-col-reverse w-full px-[30px] gap-4 items-center sm:flex-row sm:justify-center pt-[50px] laptop:pb-[20px] desktop:justify-evenly desktop:max-w-[1620px] desktop:mx-auto desktop:gap-10">
      <div className="hidden laptop:block h-[160px] w-[160px] bg-[#F0F600] absolute top-0 left-0" />

      <div className="hidden laptop:block top-[82px] laptop:left-1/3 desktop:left-1/2 desktop:-translate-x-[70%] h-[157px] w-[320px] bg-[#CECCFE] absolute z-0 rounded-bl-full rounded-br-full" />
      ...
      <div className="hidden laptop:block bottom-[20px] -translate-y-1/2 translate-x-1/2 left-1/3 w-0 h-0 border-l-[105px] border-r-[110px] border-r-transparent border-l-transparent border-b-[#B6AFFF] border-b-[110px] absolute rotate-[45.5deg]" />
