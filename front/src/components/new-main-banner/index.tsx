    ...
    return (
        ...
        >
            <div className="flex flex-col gap-[42px] px-5 md:max-w-[60%] laptop:max-w-full w-full laptop:gap-[24px] laptop:pl-[100px] desktopLg:px-0 desktopLg:max-w-[1620px] desktop:mx-auto">
                <h1 className="text-[24px] text-white font-extrabold sm:text-[40px] laptop:text-[30px] laptop:max-w-[412px] desktop:text-[40px] desktopLg:text-[50px] desktop:max-w-[700px] desktopLg:max-w-[850px]">
                    {t('main_banner.ttl')}
                </h1>
