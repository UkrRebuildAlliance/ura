...
export const MainBanner = ({}) => {
    ...
    return (
        <section className="bg-homeBanner_sm tablet:bg-homeBanner flex justify-center items-center md:justify-start w-full bg-cover bg-no-repeat aspect-[1/1.5] tablet:aspect-[1/1] laptop:aspect-[1.33/1] tablet:bg-center desktop:aspect-[2.45/1] ">
