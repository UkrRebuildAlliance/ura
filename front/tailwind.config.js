  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        historyBanner_sm: "url('/src/assets/img/banner_history_sm.png')",
        ...
        btnGradient: 'linear-gradient(90deg, #483BC9 0%, #225FDD 100%);',
        btnTransparent:
          'linear-gradient(180deg, rgba(255,255,255,0) 0%, rgba(255,255,255,0) 100%)',
        btnBgGradient: 'linear-gradient(90deg, #483BC9 0.28%, #5CD68D 99.78%);',
